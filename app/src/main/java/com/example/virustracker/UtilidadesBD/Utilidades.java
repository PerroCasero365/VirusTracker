...
public class Utilidades
{
    ...
    public static final String TABLA_USUARIO = "dispositivosInfectados";
    ...
    public static final String CREAR_TABLA_USUARIO = "CREATE TABLE IF NOT EXISTS "+TABLA_USUARIO+" ("+CAMPO_DEVICE_ID+" INTEGER NOT NULL PRIMARY KEY, "+CAMPO_DATE_STATUS+" TEXT)";
